...
export function ActiveTaskLogoutModal({ isOpen, onStopAndLogout, onCancel, taskName }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        {/* Gradient accent line at top - Orange/Red warning */}
        <div
        ...
        <div className="p-8">
          ...
          >
            <Clock width={32} height={32} style={{ color: '#FBBF24' }} />
          </motion.div>
          ...
          <motion.p
            ...
            style={{ color: '#94A3B8' }}
          >
            Your timer is still tracking "<span style={{ color: '#FBBF24', fontWeight: 500 }}>{taskName}</span>". Would you like to stop and log out?
          </motion.p>
