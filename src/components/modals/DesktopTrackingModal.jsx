...
export function DesktopTrackingModal({ isOpen, onOpenApp }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        {/* Gradient accent line at top - Green success */}
        <div
        ...
        <div className="p-8">
          ...
          >
            ...
            >
              <CheckCircle width={32} height={32} style={{ color: '#34D399' }} />
            </motion.div>
          </motion.div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            onClick={onOpenApp}
            className="text-sm font-semibold flex items-center justify-center gap-2 mx-auto transition-all"
            style={{ color: '#60A5FA' }}
          >
            Open desktop app
